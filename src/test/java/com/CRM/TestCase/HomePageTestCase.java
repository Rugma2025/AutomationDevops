...
public class HomePageTestCase extends BaseClass {
	//The method declared in the page class should be called here
  ...
  public void verifyUrl() 
  {
   ...
   Assert.assertTrue(actUrl.contains("crm"),"Test Case fail!");
  ...
  {
	 String nextPageUrl=hp.testSignInLink();
	 Assert.assertTrue(nextPageUrl.contains("login"),"Test Fail:Login page not open");
	 System.out.println("Test Pass:Application navigated to LoginPage");
  }
}
